...
This paper addresses both problems. We propose IWCM to eliminate autoregressive chain drift, with a z0-replication initialization that requires no rollout model, and demonstrate it empirically on real physics across three continuous-control domains.
